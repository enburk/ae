void print (const Entity & entity, array<string> & lines, int indent = 0, bool semicolon = true)
{
    string line;
    ...
    {
        bool inner_semicolon = entity.kind != "enum" && entity.kind != "variable";
        bool outer_semicolon = entity.kind == "enum" || entity.kind == "variable" || entity.kind == "function" || entity.kind == "lambda" || entity.kind == "class" || entity.kind == "union";
